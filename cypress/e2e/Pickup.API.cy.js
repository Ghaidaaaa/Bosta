...
describe('API Test for generate-text endpoint', () => {
...
//   --data-raw '{"businessLocationId":"Q1MCImvcs","contactPerson":{"_id":"pvE7i1MA_8","name":"Elkholaey","phone":"+201202436309"},"scheduledDate":"2025-04-15","numberOfParcels":"3","hasBigItems":false,"repeatedData":{"repeatedType":"One Time"},"creationSrc":"Web"}`
      }
    ],
    "stop": ["\n"]  ,
  ...
  it('should call generate-text endpoint and save response as test file', () => {
    ...
    console.log(response);
      ...
      cy.task('createTestFile', {
        content,
        fileName: 'generated-pickup-test'
      }).then((filePath) => {
